    ...
    */
    ...
    constructor() {
        ...
        this.arrayInitialization = () => {
            ...
            this.active_array = new Array(this.cells_in_column * this.cells_in_rows);
        ...
        this.arrayRandomize = () => {
            ...
            for (let i = 0; i < this.cells_in_rows * this.cells_in_column; i++) {
        ...
        this.fillArray = () => {
            ...
            for (let i = 0; i < this.cells_in_rows; i++) {
                for (let j = 0; j < this.cells_in_column; j++) {
                    let color;
                    if (this.active_array[j + (i * this.cells_in_column)] == 1)
        ...
        this.setCellValueHelper = (row, col) => {
            try {
                return this.active_array[col + (row * this.cells_in_column)];
            }
            catch {
                return 0;
            }
        ...
        this.updateCellValue = (row, col) => {
            ...
            else if (this.active_array[col + (row * this.cells_in_column)] === 0 && total === 3) {
                return 1;
            }
        ...
        this.updateLifeCycle = () => {
            ...
            for (let i = 0; i < this.cells_in_rows; i++) {
                for (let j = 0; j < this.cells_in_column; j++) {
                    ...
                    this.inactive_array[j + (i * this.cells_in_column)] = new_state;
                }
            }
